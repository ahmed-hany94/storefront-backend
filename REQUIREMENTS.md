...
| column name              | type      | attriutes            |
| ------------------------ | --------- | -------------------- |
| order_product_id (PK)    | uuid      | generated by default |
| order_id (FK)            | uuid      | not null             |
| product_id (FK)          | uuid      | generated by default |
| quantity                 | int       | not null             |
| order_product_created_at | TIMESTAMP | generated by default |
